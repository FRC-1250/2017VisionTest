...
import org.usfirst.frc.team1250.robot.commands.CmdG_AutonLeft;
import org.usfirst.frc.team1250.robot.commands.Cmd_AutoDrive;
...
import org.usfirst.frc.team1250.robot.subsystems.Sub_RimeRight;
...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		m_oi = new OI();
		m_chooser.addDefault("DriveStraight", new Cmd_AutoDrive(60, 0.8,0.4));
		m_chooser.addObject("Rotate", new Cmd_AutoTurn(90,0.8,0.6));
		m_chooser.addObject("Drive Turn", new CmdG_AutonLeft());
